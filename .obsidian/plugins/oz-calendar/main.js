  ...
  constructor() {
    ...
    this.handleRename = (file, oldPath) => {
      ...
      if (file.name.length >= this.settings.dateFormat.length) {
        ...
        if (this.settings.dateSource === "filename" && (0, import_dayjs4.default)(cleanFileName, this.settings.dateFormat, true).isValid()) {
          let parsedDayISOString = (0, import_dayjs4.default)(cleanFileName, this.settings.dateFormat).format("YYYY-MM-DD");
          if (parsedDayISOString in this.OZCALENDARDAYS_STATE) {
    ...
    this.handleCreate = (file) => {
      if (file instanceof import_obsidian7.TFile && file.extension === "md" && this.settings.dateSource === "filename") {
        let cleanFileName = file.name.substring(0, this.settings.dateFormat.length);
        if ((0, import_dayjs4.default)(cleanFileName, this.settings.dateFormat, true).isValid()) {
          let parsedDayISOString = (0, import_dayjs4.default)(cleanFileName, this.settings.dateFormat).format("YYYY-MM-DD");
          if (parsedDayISOString in this.OZCALENDARDAYS_STATE) {
            this.OZCALENDARDAYS_STATE[parsedDayISOString] = [
              ...this.OZCALENDARDAYS_STATE[parsedDayISOString],
        ...
        if (this.settings.dateSource === "yaml") {
          ...
          if (fileCache && fileCache.frontmatter) {
            ...
            for (let k4 of Object.keys(fm)) {
              if (k4 === this.settings.yamlKey) {
                let fmValue = String(fm[k4]).substring(0, this.settings.dateFormat.length);
          ...
          if (mdFile.name.length >= dateFormatLength) {
            ...
            if ((0, import_dayjs4.default)(value, this.settings.dateFormat, true).isValid()) {
              let parsedDayISOString = (0, import_dayjs4.default)(value, this.settings.dateFormat).format("YYYY-MM-DD");
              if (parsedDayISOString in OZCalendarDays) {
                OZCalendarDays[parsedDayISOString] = [
                  ...OZCalendarDays[parsedDayISOString],
                  mdFile.path
