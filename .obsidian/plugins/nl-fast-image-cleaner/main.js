...
// src/command/delAllAttachmentsOfTheNote.ts
var import_obsidian2 = require("obsidian");

// src/utils/deleteAttachmentWhenDeleteNote.ts
var import_obsidian = require("obsidian");
var SUCCESS_NOTICE_TIMEOUT = 1800;
var deleteAttachmentWhenDeleteNote = (file, plugin) => __async(void 0, null, function* () {
  ...
  try {
    ...
    console.error(error);
    new import_obsidian.Notice("Faild to delelte the image !", SUCCESS_NOTICE_TIMEOUT);
  }
});

// src/command/delAllAttachmentsOfTheNote.ts
var delAllAttachsByCommand = (plugin) => __async(void 0, null, function* () {
      ...
      for (const [filePath, nr] of Object.entries(links)) {
        ...
        try {
          ...
          if (AttachFile instanceof import_obsidian2.TFile) {
            yield deleteAttachmentWhenDeleteNote(AttachFile, plugin);
          }
        } catch (error) {
          console.error(error);
          return void 0;
...
var delAllAttachsByFileMenu = (plugin, currentFile) => __async(void 0, null, function* () {
  const resolvedLinks = app.metadataCache.resolvedLinks;
  for (const [mdFile, links] of Object.entries(resolvedLinks)) {
    if ((currentFile == null ? void 0 : currentFile.path) === mdFile) {
      for (const [filePath, nr] of Object.entries(links)) {
        if (isReferencedByOtherNotes(filePath, currentFile))
          continue;
        try {
          const AttachFile = app.vault.getAbstractFileByPath(filePath);
          if (AttachFile instanceof import_obsidian2.TFile) {
...
// src/utils/deleteNote.ts
var import_obsidian3 = require("obsidian");
var SUCCESS_NOTICE_TIMEOUT2 = 1800;
var deleteNote = (file, plugin) => __async(void 0, null, function* () {
  const deleteOption = plugin.settings.deleteOption;
  try {
    if (deleteOption === ".trash") {
      yield app.vault.trash(file, false);
    ...
    console.error(error);
    new import_obsidian3.Notice("Faild to delelte the note !", SUCCESS_NOTICE_TIMEOUT2);
  }
});
...
var addCommand = (myPlugin) => {
  myPlugin.addCommand({
    ...
    callback: () => __async(void 0, null, function* () {
      yield delAllAttachsByCommand(myPlugin);
      yield deleteNote(app.workspace.getActiveFile(), myPlugin);
    })
  });
};
...
var NathanDeleteAttactmentSettingsTab = class extends import_obsidian4.PluginSettingTab {
  ...
  display() {
    ...
    new import_obsidian4.Setting(containerEl).setName("Deleted Attachment Destination").setDesc("Select where you want Attachments to be moved once they are deleted").addDropdown((dropdown) => {
...
var LogsModal = class extends import_obsidian5.Modal {
...
// src/util.ts
var SUCCESS_NOTICE_TIMEOUT3 = 1800;
      ...
      for (const [filePath, nr] of Object.entries(links)) {
        if (filePath.includes(FileBaseName)) {
          try {
            ...
            new import_obsidian6.Notice(` cannot get the image file`);
            console.error(error);
            return void 0;
          }
        }
...
var ClearAttachment = (FileBaseName, plugin) => __async(void 0, null, function* () {
  ...
  try {
    if (deleteOption === ".trash") {
      yield app.vault.trash(file, false);
      new import_obsidian6.Notice("Image moved to Obsidian Trash !", SUCCESS_NOTICE_TIMEOUT3);
    } else if (deleteOption === "system-trash") {
      yield app.vault.trash(file, true);
      new import_obsidian6.Notice("Image moved to System Trash !", SUCCESS_NOTICE_TIMEOUT3);
    } else if (deleteOption === "permanent") {
      yield app.vault.delete(file);
      new import_obsidian6.Notice("Image deleted Permanently !", SUCCESS_NOTICE_TIMEOUT3);
    }
  } catch (error) {
    console.error(error);
    new import_obsidian6.Notice("Faild to delelte the image !", SUCCESS_NOTICE_TIMEOUT3);
  }
});
...
// src/main.ts
var NathanDeletefile = class extends import_obsidian7.Plugin {
  constructor() {
    super(...arguments);
        ...
        if (file instanceof import_obsidian7.TFile) {
          const addMenuItem = (item) => {
            ...
            item.onClick(() => __async(this, null, function* () {
              yield delAllAttachsByFileMenu(this, file);
              yield deleteNote(app.workspace.getActiveFile(), this);
            }));
          };
